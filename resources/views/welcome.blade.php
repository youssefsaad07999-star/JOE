        ...
        <div class="relative max-w-7xl mx-auto px-6 w-full">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-4 mt-8">
                        @foreach($genders as $gender)
                            <a href="{{ route('gender.index', ['gender' => $gender->slug]) }}" class="group px-8 py-3.5 border {{ $loop->first ? 'bg-[#C85C6E] border-[#C85C6E] text-white hover:bg-transparent hover:text-[#C85C6E]' : 'border-white/30 text-white hover:border-white' }}
                ...
                <div class="relative hidden md:block">
                    ...
                    <div class="h-140 w-150 relative rounded-3xl overflow-hidden aspect-[4/5]">
                        <img src="{{ asset('images/Landing2.png') }}" class="w-full h-full object-cover"
                    ...
                    {{-- <div class="absolute -bottom-6 -left-8 bg-white rounded-2xl p-4 shadow-2xl">
                        ...
                        <div class="flex items-center gap-1 mt-1">
                            @for($i = 0; $i < 5; $i++)
                                <svg class="w-3 h-3 text-[#C85C6E]" fill="currentColor" viewBox="0 0 20 20">
                                    <path
    ...
    <section class="bg-[#1C1C1C] text-white py-14">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                @foreach([
                        ['icon' => 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4', 'title' => 'Free Shipping', 'desc' => 'On orders over $80'],
                        ['icon' => 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15', 'title' => 'Easy Returns', 'desc' => '30-day free returns'],
                        ['icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', 'title' => 'Secure Payment', 'desc' => '100% protected checkout'],
                        ['icon' => 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z', 'title' => 'Style Help', 'desc' => 'Expert fashion advice'],
                    ] as $feature)
