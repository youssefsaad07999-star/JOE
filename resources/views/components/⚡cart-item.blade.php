...
new class extends Component {
    // Computed property to always fetch fresh cart items with their relationships
    #[Computed]
    ...
    public function removeItem($itemId)
    {
        ...
        $item->delete();
        session()->flash('success', 'Item removed from your bag.');
    }

    public function clearCart()
    {
        $this->currentCartQuery()->delete();
        session()->flash('success', 'Your bag has been cleared.');
    }
