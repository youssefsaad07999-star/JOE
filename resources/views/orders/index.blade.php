    ...
    <div class="max-w-4xl mx-auto px-6 py-10">
            ...
            <div class="bg-white rounded-2xl shadow-sm mb-4 overflow-hidden">
                ...
                <div
                    ...
                    <a href="{{ route('order.show', $order) }}"
                        class="text-sm text-[#C85C6E] hover:underline font-medium whitespace-nowrap">
                        View Details →
                    </a>
                </div>
                ...
                <div class="px-6 py-4 flex gap-3">
                    @foreach ($order->variants->take(4) as $variant)
                    ...
                    @if ($order->variants->count() > 4)
                        <div class="w-14 h-16 rounded-lg bg-gray-100 flex items-center justify-center flex-shrink-0">
                            <span class="text-xs text-gray-500 font-medium">+{{ $order->variants->count() - 4 }}</span>
                        </div>
                    @endif
                </div>
            </div>
        @empty
            <div class="text-center py-24">
                ...
                <p class="text-gray-400 text-sm font-light mb-8">Your orders will appear here once you make a purchase.
                </p>
                <a href="/"
