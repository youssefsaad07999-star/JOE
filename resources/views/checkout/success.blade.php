<x-layout>
    <div class="max-w-2xl mx-auto px-6 py-20 text-center">
        ...
        <p class="text-gray-500 font-light leading-relaxed">
            Your order <span class="font-semibold text-[#1C1C1C]">#{{ $order->id }}</span> has been placed successfully.
            We've sent a confirmation to <span class="font-medium">{{ $order->email }}</span>.
        </p>
